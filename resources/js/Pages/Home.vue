<template>
    <div class="flex flex-row bg-gray-900 h-screen">
        <div class="min-w-nav">
            <navbar></navbar>
        </div>
        ...
        <div class="flex flex-col w-full">
            <div class="flex justify-between w-full px-44">
                <div class="">
                    <p class="text-center mt-5 mx-auto text-white font-semibold text-4xl cursor-default">Home</p>
                </div>
                <div class="w-full">
            ...
            <HomeContent :liveChannels="liveChannels"></HomeContent>
        </div>
    </div>
</template>
...
<script>
    ...
    import LiveHackers from '@/Components/LiveHackers'

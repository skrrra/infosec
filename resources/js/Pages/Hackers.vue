    ...
    <div class="bg-gray-900 flex flex-row h-screen">
        ...
        <div class="flex flex-col w-full">
            <div class="flex justify-between w-full px-44">
                <div class="">
                    <p class="text-center mt-5 mx-auto text-white font-semibold text-4xl cursor-default">Hackers</p>
                </div>
                <div class="w-full">
            ...
            <div class="w-full h-screen text-white">
                <div class="grid grid-cols-2 mt-10">
                    <div v-for="a in test" class="mx-10">
                        <div class="flex flex-row">
                            <img :src="a.profile_image_url" class="h-28" alt="Streamer avatar">
                            <div class="">
                                <p v-text="a.login"></p>
                                <p v-text="a.description" class="font-light text-sm"></p>
                            </div>
                        </div>
                    </div>
                </div>
